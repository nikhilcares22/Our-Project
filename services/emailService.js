...
const getTypeMsg = function (type, token) {
    ...
    switch (type) {
        case 1:
            ...
            please click on the link below to confirm that it is you who want to reset password or ignore if that's not you ${constants.TEMPBASE}user/resetpassword/?code=${token}`
            break;
